                ...
                <Tr {...row?.getRowProps()} key={index}>
                  {row?.cells?.map((cell, index) => {
                    ...
                    if (cell?.column.Header === "#") {
                        ...
                        <Link
                          to={
                            user && user.role !== "superAdmin"
                              ? `/leadView/${cell?.row?.values._id || ""}`
                              : `/admin/leadView/${cell?.row?.values._id || ""}`
                          }
                        >
                          <Text
                            me="10px"
                      ...
                      cell?.column.Header &&
                      cell?.column.Header === "Lead PhoneNumber"
                    ) {
                      data = (
                        <Text
                          me="10px"
                      ...
                      cell?.column.Header &&
                      cell?.column.Header === "Lead Address"
                    ) {
                      data = (
                        <Text
                          color={textColor}
